...
const EnglishCoursesPage: React.FC = () => {
  ...
  const successStories = [
    {
      name: "Emma Martinez",
      grade: "7th Grade",
      improvement: "Improved writing skills by 85% in one semester",
      quote: "The English courses helped me find my voice and express my ideas clearly.",
      course: "English Mastery K-12",
      image: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face"
    },
    {
      name: "Marcus Chen",
      grade: "5th Grade", 
      improvement: "Reading level increased by 2 grades in 4 months",
      quote: "Reading Enrichment made books fun and exciting. Now I love reading every day!",
      course: "Reading Enrichment K-5",
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face"
    },
    {
      name: "Sofia Johnson",
      grade: "11th Grade",
      improvement: "SAT Writing score improved by 150 points",
      quote: "The grammar and writing courses gave me the confidence to tackle any writing assignment.",
      course: "Grammar Boost K-8",
  ...
  const programHighlights = [
    {
      icon: BookOpen,
      title: 'Proven Reading Methods',
      description: 'Research-based literacy instruction using phonics, guided reading, and comprehension strategies',
      stats: '95% reading improvement',
      color: 'text-[#F16112]'
    },
    {
      icon: PenTool,
      title: 'Writing Excellence',
      description: 'From creative storytelling to academic essays, master all forms of written communication',
      stats: '90% writing confidence boost',
      color: 'text-[#1F396D]'
    },
    {
      icon: BookMarked,
      title: 'Literature Analysis',
      description: 'Critical thinking through classic and contemporary literature study',
      stats: '98% analytical skills growth',
      color: 'text-[#F1894F]'
    },
    {
      icon: Target,
      title: 'Test Preparation',
      description: 'Comprehensive prep for SAT, ACT, AP exams, and standardized testing',
      stats: 'Average 140pt score increase',
      color: 'text-[#29335C]'
    }
  ];
  ...
  const learningOutcomes = [
    {
      ...
      outcomes: [
        'Decode complex texts with confidence',
        'Analyze themes and literary devices',
        'Improve reading comprehension by 85%',
    ...
    },
    {
      ...
      outcomes: [
        ...
        'Develop persuasive argumentation',
        'Create engaging creative works',
    ...
    },
    {
      ...
      outcomes: [
        ...
        'Present work to peers effectively',
    ...
    <div className="min-h-screen bg-[#ebebeb]" style={{ fontFamily: '"Nunito", "Inter", system-ui, sans-serif' }}>
      ...
      <section className="py-16 px-4 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Program <span className="text-[#F16112]">Highlights</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our English Language Arts programs deliver exceptional results through proven methodologies and personalized instruction.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {programHighlights.map((highlight, index) => {
              ...
              return (
                <Card key={index} className="bg-gradient-to-br from-gray-50 to-white rounded-[20px] shadow-lg hover:shadow-xl transition-all duration-300 group">
                  <CardContent className="p-6 text-center">
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}>
                      <IconComponent className={`w-8 h-8 ${highlight.color}`} />
                    </div>
                    <h3 className="font-bold text-lg text-gray-900 mb-3">{highlight.title}</h3>
                    <p className="text-gray-600 text-sm mb-4 leading-relaxed">{highlight.description}</p>
                    <div className={`font-bold text-sm ${highlight.color} bg-gray-100 px-3 py-1 rounded-full inline-block`}>
                      {highlight.stats}
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="py-16 px-4 lg:px-8" style={{
        background: `
          radial-gradient(circle at 25% 25%, rgba(31, 57, 109, 0.08) 0%, transparent 15%),
          radial-gradient(circle at 80% 35%, rgba(241, 137, 79, 0.1) 0%, transparent 20%),
          radial-gradient(circle at 45% 70%, rgba(31, 57, 109, 0.06) 0%, transparent 25%),
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Learning <span className="text-[#F16112]">Outcomes</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Our comprehensive English Language Arts programs help students achieve measurable learning outcomes across all key areas.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {learningOutcomes.map((outcome, index) => (
              <Card key={index} className="bg-white rounded-[20px] shadow-lg hover:shadow-xl transition-all duration-300 group">
                <CardContent className="p-6">
                  <div className="text-center mb-6">
                    <div className="text-4xl mb-3">{outcome.icon}</div>
                    <h3 className="font-bold text-lg text-gray-900">{outcome.category}</h3>
                  </div>
                  <ul className="space-y-3">
                    {outcome.outcomes.map((item, itemIndex) => (
                      <li key={itemIndex} className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#F16112] mt-0.5 flex-shrink-0" />
      ...
      <section className="py-16 px-4 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Success <span className="text-[#F16112]">Stories</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Hear from our students and families about their English Language Arts journey at GrowWise.
            </p>
          </div>
            ...
            {successStories.map((story, index) => (
              <Card key={index} className="bg-gradient-to-br from-gray-50 to-white rounded-[20px] shadow-lg hover:shadow-xl transition-all duration-300 group">
                <CardContent className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="inline-block bg-[#F16112]/10 text-[#F16112] px-3 py-1 rounded-full text-sm font-semibold mb-3">
                      {story.improvement}
                    </div>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    <p className="text-sm text-gray-500">Course: <span className="font-semibold text-gray-700">{story.course}</span></p>
                  </div>
                </CardContent>
              </Card>
            ))}
