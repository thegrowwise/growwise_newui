    ...
    <main className="section-base section-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/academic" className="card-base card-padding hover:shadow-xl rounded-xl border border-gray-100">
            <div className="text-strong text-lg mb-2">Academic</div>
            <div className="text-muted">K-12 Math and English programs</div>
          </Link>
          <Link href="/steam" className="card-base card-padding hover:shadow-xl rounded-xl border border-gray-100">
