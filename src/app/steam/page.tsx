...
import { ChevronRight, Code, Gamepad2, Brain, Lightbulb, Rocket, Users, Award, Target, Clock, CheckCircle, Monitor, Palette, Globe, X, Sparkles } from 'lucide-react';
...
const STEAMPage: React.FC = () => {
  ...
  const steamPrograms = [
    { id: 'game-development', title: 'Game Development', description: 'Create immersive games and interactive experiences using industry-standard tools', icon: Gamepad2, gradient: 'from-[#F16112] to-[#F1894F]', bgGradient: 'bg-gradient-to-br from-[#F16112]/5 to-[#F1894F]/10', iconColor: 'text-[#F16112]', features: ['Roblox Studio Development','Scratch Programming','Minecraft Modding','Unity Game Engine','Game Design Principles','3D Modeling Basics'] },
    { id: 'python-programming', title: 'Python Programming', description: "Master the world's most popular programming language from basics to advanced", icon: Code, gradient: 'from-[#1F396D] to-[#29335C]', bgGradient: 'bg-gradient-to-br from-[#1F396D]/5 to-[#29335C]/10', iconColor: 'text-[#1F396D]', features: ['Python Fundamentals','Object-Oriented Programming','Data Structures & Algorithms','Web Development with Flask','API Development','Project-Based Learning'] },
    { id: 'ai-ml', title: 'AI & Machine Learning', description: 'Explore artificial intelligence and machine learning concepts for the future', icon: Brain, gradient: 'from-[#1F396D] to-[#F16112]', bgGradient: 'bg-gradient-to-br from-[#29335C]/5 to-[#1F396D]/10', iconColor: 'text-[#1F396D]', features: ['AI Fundamentals','Machine Learning Basics','Prompt Engineering','Computer Vision','Natural Language Processing','Ethics in AI'] },
    { id: 'young-founders', title: 'Young Entrepreneurs', description: 'Develop entrepreneurial skills and business mindset for future leaders', icon: Lightbulb, gradient: 'from-[#F1894F] to-[#F16112]', bgGradient: 'bg-gradient-to-br from-[#F1894F]/5 to-[#F16112]/10', iconColor: 'text-[#F1894F]', features: ['Business Planning','Leadership Development','Brand Building','Financial Literacy','Marketing Fundamentals','Presentation Skills'] }
  ];

  const gameDevelopmentPrograms = [
    { id: 1, title: 'Roblox Studio Mastery', level: 'Beginner to Advanced', duration: '12 weeks', color: 'bg-gradient-to-br from-[#F16112]/20 to-[#F1894F]/30', textColor: 'text-[#F16112]', borderColor: 'border-[#F16112]/30', features: ['Game Design Fundamentals','Scripting with Lua','Building Interactive Worlds','Character Animation','Monetization Strategies','Publishing Games'] },
    { id: 2, title: 'Scratch Game Creation', level: 'Beginner Friendly', duration: '8 weeks', color: 'bg-gradient-to-br from-[#1F396D]/20 to-[#29335C]/30', textColor: 'text-[#1F396D]', borderColor: 'border-[#1F396D]/30', features: ['Visual Programming Concepts','Sprite Animation','Sound Integration','Game Logic Development','Creative Storytelling','Project Showcase'] },
    { id: 3, title: 'Unity Game Engine', level: 'Intermediate to Advanced', duration: '16 weeks', color: 'bg-gradient-to-br from-[#F1894F]/20 to-[#F16112]/30', textColor: 'text-[#F1894F]', borderColor: 'border-[#F1894F]/30', features: ['C# Programming','2D & 3D Game Development','Physics Simulation','UI/UX Design','Cross-Platform Publishing','Team Collaboration'] }
  ];

  const programmingTools = [
    { id: 1, name: 'Python', description: 'Versatile, beginner-friendly language', icon: Code, color: 'text-[#1F396D]', bgColor: 'bg-[#1F396D]/10' },
    { id: 2, name: 'JavaScript', description: 'Web development powerhouse', icon: Globe, color: 'text-[#F16112]', bgColor: 'bg-[#F16112]/10' },
    { id: 3, name: 'Scratch', description: 'Visual programming for beginners', icon: Palette, color: 'text-[#F1894F]', bgColor: 'bg-[#F1894F]/10' },
    { id: 4, name: 'Unity', description: 'Professional game development', icon: Gamepad2, color: 'text-[#29335C]', bgColor: 'bg-[#29335C]/10' },
    { id: 5, name: 'AI Tools', description: 'Machine learning platforms', icon: Brain, color: 'text-[#1F396D]', bgColor: 'bg-[#1F396D]/10' },
    { id: 6, name: 'Web Tech', description: 'HTML, CSS, React', icon: Monitor, color: 'text-[#F16112]', bgColor: 'bg-[#F16112]/10' }
  ];

  const aiLearningPaths = [
    { id: 1, title: 'AI Fundamentals', description: 'Introduction to artificial intelligence concepts and applications', duration: '6 weeks', level: 'Beginner', topics: ['What is Artificial Intelligence?','Types of AI Systems','AI in Daily Life','Ethical Considerations','Future of AI Technology'] },
    { id: 2, title: 'Machine Learning Basics', description: 'Hands-on introduction to machine learning algorithms', duration: '10 weeks', level: 'Intermediate', topics: ['Supervised Learning','Unsupervised Learning','Data Preprocessing','Model Training','Performance Evaluation'] },
    { id: 3, title: 'Prompt Engineering', description: 'Master the art of communicating with AI systems', duration: '4 weeks', level: 'All Levels', topics: ['Understanding Large Language Models','Effective Prompt Design','Creative Applications','Problem-Solving with AI','AI-Assisted Programming'] }
  ];

  const entrepreneurshipModules = [
    { id: 1, title: 'Youth CEO Program', description: 'Develop leadership and business management skills', icon: Target, features: ['Leadership Fundamentals','Team Building','Decision Making','Project Management','Communication Skills','Strategic Thinking'] },
    { id: 2, title: 'I Am Brand', description: 'Build your personal brand and online presence', icon: Sparkles, features: ['Personal Branding','Social Media Strategy','Content Creation','Digital Marketing','Networking Skills','Online Portfolio'] }
  ];

  const successStories = [
    { id: 1, name: 'Alex Chen', age: 14, program: 'Python Programming', achievement: 'Built a web app that tracks homework for his entire school', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face', quote: "GrowWise taught me that coding isn't just about syntax - it's about solving real problems." },
    { id: 2, name: 'Sophia Rodriguez', age: 16, program: 'Game Development', achievement: 'Published her first game on Roblox with 10,000+ plays', image: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=100&h=100&fit=crop&crop=face', quote: 'Creating games taught me creativity, problem-solving, and how to turn ideas into reality.' },
    { id: 3, name: 'Marcus Johnson', age: 15, program: 'Young Entrepreneurs', achievement: 'Started his own tutoring business helping younger students', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face', quote: 'The entrepreneurship program gave me the confidence to turn my passion into a business.' }
  ];

  const whyChooseSTEAM = [
    { icon: Rocket, title: 'Future-Ready Skills', description: "Learn technologies and concepts that will be essential in tomorrow's job market", bgColor: 'bg-gradient-to-br from-[#1F396D]/10 to-[#29335C]/20', color: 'text-[#1F396D]', borderColor: 'border-[#1F396D]/30' },
    { icon: Users, title: 'Collaborative Learning', description: 'Work on team projects that mirror real-world development environments', bgColor: 'bg-gradient-to-br from-[#F16112]/10 to-[#F1894F]/20', color: 'text-[#F16112]', borderColor: 'border-[#F16112]/30' },
    { icon: Target, title: 'Project-Based Approach', description: 'Build real applications and games that showcase your skills', bgColor: 'bg-gradient-to-br from-[#F1894F]/10 to-[#F16112]/20', color: 'text-[#F1894F]', borderColor: 'border-[#F1894F]/30' },
    { icon: Award, title: 'Industry Recognition', description: 'Earn certificates and build portfolios that impress colleges and employers', bgColor: 'bg-gradient-to-br from-[#29335C]/10 to-[#1F396D]/20', color: 'text-[#29335C]', borderColor: 'border-[#29335C]/30' }
  ];
      ...
      <section className="py-20 px-4 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <Badge className="bg-[#F16112] text-white mb-6 px-6 py-2 rounded-full">STEAM PROGRAMS</Badge>
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Science, Technology, Engineering, 
              <span className="block bg-gradient-to-r from-[#F16112] to-[#F1894F] bg-clip-text text-transparent">Arts & Mathematics</span>
            </h1>
      ...
      <section className="py-20 px-4 lg:px-8 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {gameDevelopmentPrograms.map(program => (
        ...
        <DialogContent className="bg-white/90 backdrop-blur-3xl border-2 border-white/60 shadow-[0px_40px_120px_0px_rgba(31,57,109,0.3)] rounded-[32px] max-w-2xl p-0 overflow-hidden ring-1 ring-white/30">
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* ML/AI Coding Option */}
              <Card 
                onClick={() => { router.push('/steam/ml-ai-coding'); setIsExploreModalOpen(false); }}
              ...
              <Card 
                onClick={() => { router.push('/steam/game-development'); setIsExploreModalOpen(false); }}
                className="bg-white/40 backdrop-blur-2xl border-2 border-white/50 rounded-[24px] shadow-[0px_20px_50px_rgba(255,255,255,0.3)] hover:shadow-[0px_30px_80px_rgba(255,255,255,0.4)] transition-all duration-500 cursor-pointer group hover:scale-105 transform overflow-hidden relative ring-1 ring-white/40 h-full"
              >
                {/* Enhanced Background gradient */}
