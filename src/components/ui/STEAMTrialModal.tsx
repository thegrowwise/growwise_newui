...
const STEAMTrialModal: React.FC<STEAMTrialModalProps> = ({ isOpen, onClose }) => {
  ...
  const availableSubjects = [
    t('assessment.trial.subjects.coding'), 
    t('assessment.trial.subjects.ai'), 
    t('assessment.trial.subjects.gameDev'), 
    t('assessment.trial.subjects.robotics')
  ];
                ...
                <>
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-base lg:text-lg">
                      Experience our STEAM programs with a hands-on trial class
                    </p>
                  </div>
