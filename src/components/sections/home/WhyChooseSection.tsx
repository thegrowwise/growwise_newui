  ...
  return (
    <section className="py-20 px-4 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <h2 className="text-4xl lg:text-5xl font-bold text-center mb-16 text-gray-900 animate-fade-in-up">Why Choose <span className="bg-gradient-to-r from-[#F16112] to-[#F1894F] bg-clip-text text-transparent">GrowWise</span>?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {items.map((item, idx) => {
            const Icon = item.IconComponent as any;
            return (
              <div key={idx} className="text-center group animate-fade-in-up" style={{ animationDelay: `${idx * 0.15}s` }}>
